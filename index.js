...
const client = new AzureOpenAI({
  endpoint: "https://bansa-m5ut6z6d-northcentralus.openai.azure.com/",
  apiKey:
    "Cy9TDTcXJUEVc40ywZYvHklU8kl1AvH0fvZ3oQMH4q3cLAlTJa5jJQQJ99BAACHrzpqXJ3w3AAAAACOGTbAX",
  deployment,
  apiVersion,
});
...
const previous_json = {
    ...
    "segments": [
      ...
      },
      {
        "id": "body_001",
        "category": "BODY_TEXT",
        "content": "A qubit can exist in multiple states simultaneously unlike classical bits.",
        "relationships": {
          "parent": "h2_001",
          "children": [],
          "siblings": [],
      ...
      },
      {
        "id": "body_002",
        "category": "BODY_TEXT",
        "content": "Qubits can be linked so the state of one directly affects another.",
        "relationships": {
          "parent": "h2_002",
          "children": [],
          "siblings": [],
    ...
    "document_flow": {
      ...
      "semantic_groups": {
        "differences_from_classical_computing": ["h1_001", "h2_001", "h2_002", "h2_003"],
